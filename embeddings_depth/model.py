...
class Encoder(nn.Module):
    def __init__(self, use_batch_norm=False):
        ...
        self.enc4 = nn.Conv2d(16, 8, kernel_size=4, padding=1)
...
class Decoder(nn.Module):
    def __init__(self, use_batch_norm=False):
        ...
        # decoder layers
        self.dec1 = nn.ConvTranspose2d(8, 8, kernel_size=5, stride=2, padding=1, output_padding=1)
        self.dbn1 = nn.BatchNorm2d(8) if use_batch_norm else nn.Identity()
        self.dec2 = nn.ConvTranspose2d(8, 16, kernel_size=5, stride=2, padding=1, output_padding=1)
